...
const API_PRODUCTION = "https://api.weekdayapp.com/v1";
...
const TEAM_ID = "TEAM";
const INVALID_URL = "https://app.weekdayapp.com/invalid";
const URL = "https://app.weekdayapp.com/testing?userId=" + USER_ID + "&teamId=" + TEAM_ID + "&channelId=" + CHANNEL_ID;
